...
def normalise_input(user_input):
	...
	'help'
	"""
	elim_punct = remove_punct(user_input)
	no_spaces = remove_spaces(elim_punct)
...
#exit_leads_to(rooms["Reception"]["exits"], "east")
#exit_leads_to(rooms["Tutor"]["exits"], "west")
#exit_leads_to(rooms["Admins"]["exits"], "north")
#exit_leads_to(rooms["Parking"]["exits"], "east")
#exit_leads_to(rooms["Parking"]["exits"], "south")
#exit_leads_to(rooms["Office"]["exits"], "west")
...
#print_menu_line("west", "the parking lot")
#print_menu_line("west", "Reception")
#print_menu_line("north", "Reception")
#print_menu_line("west", "the parking lot")
#print_menu_line("south", "Reception")
#print_menu_line("east", "Office")
