...
def execute_go(direction):
    ...
    if is_valid_exit(cureent_room["exits"], direction) == True:

    	print("Youy are going to " + exitr_lead_to(current_room["exits"], direction))
...
def main():
    ...
    while game_complete == False:
        ...
        if len(current_room["items"]) == 6:
            print("Woohoo!!Wow you have won!! Congrats!!")
            game_complete = True
        else:
